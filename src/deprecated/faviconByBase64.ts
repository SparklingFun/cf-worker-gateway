 ...
 * @param b64str Image data encoded in Base64, accept "ignored" for empty `favicon.icon`
 *               (just for avoiding HTTP Code 500).
 * @returns Middleware handler
 */
export default function faviconByBase64(b64str: string, useExactPath = false) {
